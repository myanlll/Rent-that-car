...
class Ui_Araclar(object):
    def setupUi(self, Araclar):
        if not Araclar.objectName():
            Araclar.setObjectName(u"Araclar")
        Araclar.resize(1510, 580)
        self.verticalLayoutWidget = QWidget(Araclar)
        ...
        self.tableWidget = QTableWidget(Araclar)
        ...
        self.gridLayoutWidget = QWidget(Araclar)
        ...
        self.comboBox_tur = QComboBox(Araclar)
        self.comboBox_tur.addItem("")
        self.comboBox_tur.addItem("")
        self.comboBox_tur.addItem("")
        self.comboBox_tur.addItem("")
        self.comboBox_tur.addItem("")
        self.comboBox_tur.addItem("")
        self.comboBox_tur.setObjectName(u"comboBox_tur")
        self.comboBox_tur.setGeometry(QRect(78, 76, 251, 24))
        self.comboBox_yakit = QComboBox(Araclar)
        self.comboBox_yakit.addItem("")
        self.comboBox_yakit.addItem("")
        self.comboBox_yakit.addItem("")
        self.comboBox_yakit.addItem("")
        self.comboBox_yakit.setObjectName(u"comboBox_yakit")
        self.comboBox_yakit.setGeometry(QRect(409, 76, 251, 24))
        self.comboBox_vites = QComboBox(Araclar)
        self.comboBox_vites.addItem("")
        self.comboBox_vites.addItem("")
        self.comboBox_vites.setObjectName(u"comboBox_vites")
        self.comboBox_vites.setGeometry(QRect(407, 116, 251, 24))

        self.retranslateUi(Araclar)

        QMetaObject.connectSlotsByName(Araclar)
    # setupUi

    def retranslateUi(self, Araclar):
        Araclar.setWindowTitle(QCoreApplication.translate("Araclar", u"Ara\u00e7lar", None))
        self.push_yeni.setText(QCoreApplication.translate("Araclar", u"Yeni", None))
        self.push_guncelle.setText(QCoreApplication.translate("Araclar", u"G\u00fcncelle", None))
        self.push_kaydet.setText(QCoreApplication.translate("Araclar", u"Kaydet", None))
        self.push_sil.setText(QCoreApplication.translate("Araclar", u"Sil", None))
        self.push_ara.setText(QCoreApplication.translate("Araclar", u"Ara", None))
        ___qtablewidgetitem = self.tableWidget.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("Araclar", u"1", None));
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Araclar", u"2", None));
        ___qtablewidgetitem2 = self.tableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Araclar", u"3", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Araclar", u"4", None));
        ___qtablewidgetitem4 = self.tableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Araclar", u"5", None));
        ___qtablewidgetitem5 = self.tableWidget.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("Araclar", u"6", None));
        ___qtablewidgetitem6 = self.tableWidget.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("Araclar", u"7", None));
        ___qtablewidgetitem7 = self.tableWidget.horizontalHeaderItem(7)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("Araclar", u"8", None));
        ___qtablewidgetitem8 = self.tableWidget.horizontalHeaderItem(8)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("Araclar", u"9", None));
        ___qtablewidgetitem9 = self.tableWidget.horizontalHeaderItem(9)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("Araclar", u"10", None));
        ___qtablewidgetitem10 = self.tableWidget.horizontalHeaderItem(10)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("Araclar", u"11", None));
        ___qtablewidgetitem11 = self.tableWidget.horizontalHeaderItem(11)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("Araclar", u"12", None));
        ___qtablewidgetitem12 = self.tableWidget.horizontalHeaderItem(12)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("Araclar", u"13", None));
        ___qtablewidgetitem13 = self.tableWidget.horizontalHeaderItem(13)
        ___qtablewidgetitem13.setText(QCoreApplication.translate("Araclar", u"14", None));
        ___qtablewidgetitem14 = self.tableWidget.horizontalHeaderItem(14)
        ___qtablewidgetitem14.setText(QCoreApplication.translate("Araclar", u"15", None));
        ___qtablewidgetitem15 = self.tableWidget.horizontalHeaderItem(15)
        ___qtablewidgetitem15.setText(QCoreApplication.translate("Araclar", u"16", None));
        ___qtablewidgetitem16 = self.tableWidget.verticalHeaderItem(0)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("Araclar", u"1", None));
        self.label_7.setText(QCoreApplication.translate("Araclar", u"Ara\u00e7 ID      ", None))
        self.label_12.setText(QCoreApplication.translate("Araclar", u"Renk                ", None))
        self.label_13.setText(QCoreApplication.translate("Araclar", u"\u00dcretim Y\u0131l\u0131   ", None))
        self.label_16.setText(QCoreApplication.translate("Araclar", u"\u00c7eki\u015f               ", None))
        self.label.setText(QCoreApplication.translate("Araclar", u"Marka        ", None))
        self.label_6.setText(QCoreApplication.translate("Araclar", u"Model        ", None))
        self.label_15.setText(QCoreApplication.translate("Araclar", u"Kap\u0131 Say\u0131s\u0131      ", None))
        self.label_4.setText(QCoreApplication.translate("Araclar", u"Ara\u00e7 T\u00fcr\u00fc  ", None))
        self.label_11.setText(QCoreApplication.translate("Araclar", u"Motor G\u00fcc\u00fc", None))
        self.label_8.setText(QCoreApplication.translate("Araclar", u"Vites             ", None))
        self.label_14.setText(QCoreApplication.translate("Araclar", u"Motor Hacmi", None))
        self.label_5.setText(QCoreApplication.translate("Araclar", u"Yak\u0131t             ", None))
        self.label_23.setText(QCoreApplication.translate("Araclar", u"Plaka            ", None))
        self.label_22.setText(QCoreApplication.translate("Araclar", u"G\u00fcnl\u00fck Kira ", None))
        self.label_21.setText(QCoreApplication.translate("Araclar", u"Motor No    ", None))
        self.label_24.setText(QCoreApplication.translate("Araclar", u"Durumu       ", None))
        self.comboBox_tur.setItemText(0, QCoreApplication.translate("Araclar", u"Hatchback", None))
        self.comboBox_tur.setItemText(1, QCoreApplication.translate("Araclar", u"Sedan", None))
        self.comboBox_tur.setItemText(2, QCoreApplication.translate("Araclar", u"Station Wagon", None))
        self.comboBox_tur.setItemText(3, QCoreApplication.translate("Araclar", u"Coupe", None))
        self.comboBox_tur.setItemText(4, QCoreApplication.translate("Araclar", u"SUV", None))
        self.comboBox_tur.setItemText(5, QCoreApplication.translate("Araclar", u"Cabrio", None))

        self.comboBox_yakit.setItemText(0, QCoreApplication.translate("Araclar", u"Benzin", None))
        self.comboBox_yakit.setItemText(1, QCoreApplication.translate("Araclar", u"Benzin&LPG", None))
        self.comboBox_yakit.setItemText(2, QCoreApplication.translate("Araclar", u"Dizel", None))
        self.comboBox_yakit.setItemText(3, QCoreApplication.translate("Araclar", u"Hybrid", None))

        self.comboBox_vites.setItemText(0, QCoreApplication.translate("Araclar", u"Manuel", None))
        self.comboBox_vites.setItemText(1, QCoreApplication.translate("Araclar", u"Otomatik", None))
