...
class Ui_Kiralama(object):
    def setupUi(self, Kiralama):
        if not Kiralama.objectName():
            Kiralama.setObjectName(u"Kiralama")
        Kiralama.resize(1288, 375)
        self.tableWidget = QTableWidget(Kiralama)
        ...
        self.push_kirala = QPushButton(Kiralama)
        self.push_kirala.setObjectName(u"push_kirala")
        self.push_kirala.setGeometry(QRect(1010, 180, 271, 191))
        self.verticalLayoutWidget = QWidget(Kiralama)
        ...
        self.verticalLayoutWidget_2 = QWidget(Kiralama)
        ...
        self.verticalLayoutWidget_3 = QWidget(Kiralama)
        self.verticalLayoutWidget_3.setObjectName(u"verticalLayoutWidget_3")
        self.verticalLayoutWidget_3.setGeometry(QRect(1010, 10, 271, 151))
        ...
        self.tableWidget_2 = QTableWidget(Kiralama)
        ...
        self.retranslateUi(Kiralama)

        QMetaObject.connectSlotsByName(Kiralama)
    # setupUi

    def retranslateUi(self, Kiralama):
        Kiralama.setWindowTitle(QCoreApplication.translate("Kiralama", u"Kiralama", None))
        ___qtablewidgetitem = self.tableWidget.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("Kiralama", u"1", None));
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Kiralama", u"2", None));
        ___qtablewidgetitem2 = self.tableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Kiralama", u"3", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Kiralama", u"4", None));
        ___qtablewidgetitem4 = self.tableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Kiralama", u"5", None));
        self.push_kirala.setText(QCoreApplication.translate("Kiralama", u"Kirala", None))
        self.label_14.setText(QCoreApplication.translate("Kiralama", u"Kullan\u0131c\u0131 ID  ", None))
        self.label_13.setText(QCoreApplication.translate("Kiralama", u"Ad                 ", None))
        self.label_19.setText(QCoreApplication.translate("Kiralama", u"Soyad           ", None))
        self.label_15.setText(QCoreApplication.translate("Kiralama", u"TC Kimlik     ", None))
        self.label_21.setText(QCoreApplication.translate("Kiralama", u"Ehliyet          ", None))
        self.label_16.setText(QCoreApplication.translate("Kiralama", u"Arac ID       ", None))
        self.label_17.setText(QCoreApplication.translate("Kiralama", u"Marka         ", None))
        self.label_20.setText(QCoreApplication.translate("Kiralama", u"Plaka           ", None))
        self.label_22.setText(QCoreApplication.translate("Kiralama", u"Motor No   ", None))
        self.label_18.setText(QCoreApplication.translate("Kiralama", u"G\u00fcnl\u00fck Kira", None))
        self.label_23.setText(QCoreApplication.translate("Kiralama", u"Ba\u015flang\u0131\u00e7 Tarihi               ", None))
        self.label_24.setText(QCoreApplication.translate("Kiralama", u"Biti\u015f Tarihi", None))
        self.label_25.setText(QCoreApplication.translate("Kiralama", u"Yolculuk G\u00fczergah\u0131          ", None))
        ___qtablewidgetitem5 = self.tableWidget_2.horizontalHeaderItem(0)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("Kiralama", u"1", None));
        ___qtablewidgetitem6 = self.tableWidget_2.horizontalHeaderItem(1)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("Kiralama", u"2", None));
        ___qtablewidgetitem7 = self.tableWidget_2.horizontalHeaderItem(2)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("Kiralama", u"3", None));
        ___qtablewidgetitem8 = self.tableWidget_2.horizontalHeaderItem(3)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("Kiralama", u"4", None));
        ___qtablewidgetitem9 = self.tableWidget_2.horizontalHeaderItem(4)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("Kiralama", u"5", None));
    # retranslateUi
